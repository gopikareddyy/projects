...
def load_frames(image: Image, mode='RGBA', target_size=(1024, 1024)):
    frames = [np.array(frame.convert(mode)) for frame in ImageSequence.Iterator(image)]
...
def process(num_frames, num_seeds, generator, exp_dir, load_name, caption, lambda_):
    ...
    for seed in range(num_seeds):
        ...
        with Image.open(gif_name) as im:
            ...
            save_gif(frames_collect, gif_name, target_size=(1024, 1024))
